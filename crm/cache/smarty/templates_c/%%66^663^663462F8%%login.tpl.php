<?php /* Smarty version 2.6.31, created on 2021-06-04 03:40:54
...
' autocomplete="off"></td>
                                            ...
                                            <tr>
                                                <td scope="row"><label for="username_password"><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_PASSWORD'), $this);?>
:</label></td>
                                                <td width="30%"><input type="password" size='26' tabindex="2" id="username_password" name="username_password" value='<?php echo $this->_tpl_vars['LOGIN_PASSWORD']; ?>
' autocomplete="off"></td>
                                            </tr>
