<?php /* Smarty version 2.6.31, created on 2021-06-05 16:51:58
         compiled from cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimagepath', 'cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl', 107, false),array('modifier', 'count', 'cache/themes/Sugar5/modules/Accounts/SearchForm_basic.tpl', 88, false),)), $this); ?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='companyname_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_COMPANYNAME','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['companyname_c_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['companyname_c_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['companyname_c_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['companyname_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['companyname_c_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
