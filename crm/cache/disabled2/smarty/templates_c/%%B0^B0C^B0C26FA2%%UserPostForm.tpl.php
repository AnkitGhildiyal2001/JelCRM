...
<?php if ($this->_tpl_vars['user_name'] == 'Administrator' || $this->_tpl_vars['user_name'] == 'Ed Vicinanza' || $this->_tpl_vars['user_name'] == 'Glenn Appleyard' || $this->_tpl_vars['user_name'] == 'Christine Appleyard'): ?>
...
</span> <b><?php echo $this->_tpl_vars['user_name'];  echo $this->_tpl_vars['type']; ?>
</b>&nbsp;</td>
