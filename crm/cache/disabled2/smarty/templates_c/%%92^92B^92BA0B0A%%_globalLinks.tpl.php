<?php /* Smarty version 2.6.11, created on 2016-04-14 22:02:18
...
<div id="globalLinks1"  style="padding: 7px 2px 3px; float:right;vertical-align: middle; font-size:12px; margin-left: -63px;  margin-right: 10px;">
    <ul>
...
?>
    <?php if ($this->_tpl_vars['gcl_key'] != 'training' && $this->_tpl_vars['gcl_key'] != 'about' && $this->_tpl_vars['gcl_key'] != 'employees'): ?>
    <li>
