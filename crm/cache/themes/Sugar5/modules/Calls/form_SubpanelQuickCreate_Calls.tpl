...
addToValidate('form_SubpanelQuickCreate_Calls', 'person_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_PERSON' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'calldate_c', 'date', true,'{/literal}{sugar_translate label='LBL_CALLDATE' module='Calls' for_js=true}{literal}' );
