...
<ul class="yui-nav">
<li class="selected"><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='LBL_PANEL_OVERVIEW' module='FP_events'}</em></a></li>
<li class="selected"><a id="tab1" href="javascript:void(1)"><em>{sugar_translate label='LBL_EMAIL_INVITE' module='FP_events'}</em></a></li>
</ul>
