...
addToValidate('EditView', 'lead_legal_name', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_address', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_account_executive', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_estimated_claim', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_tax_id', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_phone', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'lead_email', 'id', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Tasks' for_js=true}{literal}' );
...
addToValidate('EditView', 'companyname_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMPANYNAME ' module='Tasks' for_js=true}{literal}' );
