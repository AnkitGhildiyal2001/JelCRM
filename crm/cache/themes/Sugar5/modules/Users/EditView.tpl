...
{capture name="label" assign="label"}{sugar_translate label='LBL_AENUMBER' module='Users'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.aenumber_c.value) <= 0}
{assign var="value" value=$fields.aenumber_c.default_value }
{else}
{assign var="value" value=$fields.aenumber_c.value }
{/if}  
<input type='text' name='{$fields.aenumber_c.name}' 
id='{$fields.aenumber_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TLID' module='Users'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.tlid_c.value) <= 0}
{assign var="value" value=$fields.tlid_c.default_value }
{else}
{assign var="value" value=$fields.tlid_c.value }
{/if}  
<input type='text' name='{$fields.tlid_c.name}' 
id='{$fields.tlid_c.name}' size='30' 
maxlength='25' 
value='{$value}' title=''      >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TEAMLEADEREMAIL' module='Users'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TEAMLEADER1' module='Users'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
addToValidate('EditView', 'teamleader_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TEAMLEADER' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'teamleaderemail_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TEAMLEADEREMAIL' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'teamleader1_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TEAMLEADER1' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'tlid_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TLID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'aenumber_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_AENUMBER' module='Users' for_js=true}{literal}' );
