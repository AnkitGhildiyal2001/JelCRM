...
<input type='text' name='{$fields.address_country_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='teamleaderemail_c_advanced'>{sugar_translate label='LBL_TEAMLEADEREMAIL' module='Users'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.teamleaderemail_c_advanced.value) <= 0}
{assign var="value" value=$fields.teamleaderemail_c_advanced.default_value }
{else}
{assign var="value" value=$fields.teamleaderemail_c_advanced.value }
{/if}  
<input type='text' name='{$fields.teamleaderemail_c_advanced.name}' 
    id='{$fields.teamleaderemail_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                    </td>
            </tr>
