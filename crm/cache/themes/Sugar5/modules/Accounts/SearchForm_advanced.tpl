...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='companyname_c_advanced'>{sugar_translate label='LBL_COMPANYNAME' module='Accounts'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.companyname_c_advanced.value) <= 0}
{assign var="value" value=$fields.companyname_c_advanced.default_value }
{else}
{assign var="value" value=$fields.companyname_c_advanced.value }
{/if}  
<input type='text' name='{$fields.companyname_c_advanced.name}' 
    id='{$fields.companyname_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                    </td>
...
<input type='text' name='{$fields.email_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='taxid_c_advanced'>{sugar_translate label='LBL_TAXID' module='Accounts'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.taxid_c_advanced.value) <= 0}
{assign var="value" value=$fields.taxid_c_advanced.default_value }
{else}
{assign var="value" value=$fields.taxid_c_advanced.value }
{/if}  
<input type='text' name='{$fields.taxid_c_advanced.name}' 
    id='{$fields.taxid_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                    </td>
