...
ajaxStatus.showStatus(SUGAR.language.get('app_strings','LBL_SAVED'));window.setTimeout('ajaxStatus.hideStatus()',1000);if(buttonName == 'Tasks_subpanel_save_button'){alert('Success!');}console.log(buttonName);for(var i=0;i<saveButton.length;i++){saveButton[i].disabled=false;}}}
