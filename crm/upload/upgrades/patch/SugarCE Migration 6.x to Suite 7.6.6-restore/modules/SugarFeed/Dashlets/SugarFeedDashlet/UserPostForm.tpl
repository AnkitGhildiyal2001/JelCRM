...
*}
{if $user_name == 'Administrator' ||  $user_name == 'Ed Vicinanza' ||  $user_name == 'Glenn Appleyard' ||  $user_name == 'Christine Appleyard'}
<form name='form_{$id}' id='form_{$id}'>
<div class="dashletNonTable" style='white-space:nowrap;'>
  <table border=0 cellspacing=0 cellpadding=2>
    <tr>
      <td nowrap="nowrap"><span id='more_img_{$id}'>{$more_img}</span><span id='less_img_{$id}' style="display:none;">{$less_img}</span> <b>{$user_name}{$type}</b>&nbsp;</td>
