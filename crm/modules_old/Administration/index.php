    ...
    foreach ($module_index as $mod_key=>$mod_val) {
        ...
        (!isset($addedHeaderGroups[$values[0]]))) {
          if($key!='1'){
        	...
        	$group[$j][0] = '<table cellpadding="0" cellspacing="0" width="100%" class="h3Row adminhide'.$key.'"><tr ><td width="20%" valign="bottom"><h3>' . translate($values[0]) . '</h3></td></tr>';
...
$sugar_smarty->assign('MY_FRAME',"<iframe class='teamNoticeBox' title='https://www.sugarcrm.com/crm/product/gopro/admin' src='https://www.sugarcrm.com/crm/product/gopro/admin' width='100%' height='315px' style='display:none;'></iframe>");
